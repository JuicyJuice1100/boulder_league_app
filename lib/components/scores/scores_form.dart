...
class ScoresFormState extends State<ScoresForm> {
  ...
  /// Initialize form with values for update mode
  void initializeUpdateForm() async {
    if (isUpdate) {
        ...
        child: Column(
          ...
          children: [
            ...
            FormBuilderDropdown(
              ...
              initialValue: widget.scoredBoulder?.gymId ?? (widget.availableGyms.isNotEmpty ? widget.availableGyms.first.id : null),
